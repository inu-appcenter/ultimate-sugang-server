...
interface AdminSemesterControllerDocs {
    @Operation(
        summary = "표시 학기 조회",
        description = "프론트엔드에 노출할 학기를 조회합니다.<br>" +
    ...
    @GetMapping
    fun getSystemSemester(): ResponseEntity<SystemSemesterResponse>

    @Operation(
        summary = "표시 학기 변경",
        description = "프론트엔드에 노출할 학기를 변경합니다.<br>" +
