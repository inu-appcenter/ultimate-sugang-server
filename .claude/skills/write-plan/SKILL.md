...
1. 손댈 레이어·타입에 맞는 코드 컨벤션을 `.claude/rules/code-convention/`의 언어 디렉토리(`java/` 또는 `kotlin/`)에서 Read로 읽어라 (공통 `common.md`, 그리고 domain / dto / controller / service / repository 중 해당하는 것. Kotlin이면 `interop.md`도).
