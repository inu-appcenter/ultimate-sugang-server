...
interface CourseControllerDocs {
    @Operation(
        summary = "전공 과목 조회",
        description = "사용자의 전공에 해당하는 과목 목록을 조회합니다.<br>" +
    ...
    @Operation(
        summary = "교양 과목 조회",
        description = "이수구분 코드로 교양 과목 목록을 조회합니다.<br>" +
    ...
    @Operation(
        summary = "타학과 과목 조회",
        description = "특정 학과가 개설한 과목 목록을 조회합니다.<br>" +
    ...
    fun getInterdisciplinaryMajorCourses(
        @ParamValidation(maxLength = 40) @RequestParam("department") department: String,
    ): ResponseEntity<CoursesResponse>

    @Operation(
        summary = "과목 검색",
        description = "키워드로 과목을 검색합니다.<br>" +
            "🔐 <strong>Jwt 필요</strong><br>"
    )
    @ApiResponses(
    ...
    @Operation(
        summary = "HUSS 과목 조회",
        description = "HUSS 교과목 목록을 조회합니다.<br>" +
            "🔐 <strong>Jwt 필요</strong><br>"
    )
    @ApiResponses(
    ...
    @GetMapping("/huss")
    fun getHussCourses(): ResponseEntity<CoursesResponse>

    @Operation(
        summary = "과목 카테고리 조회",
        description = "적재된 과목의 이수구분과 그에 속한 이수영역 목록을 조회합니다.<br>" +
            "🔐 <strong>Jwt 필요</strong><br>"
    )
    @ApiResponses(
    ...
    fun getCategories(): ResponseEntity<CourseCategoriesResponse>

    @Operation(
        summary = "년도, 학기 조회",
        description = "적재된 과목의 년도와 학기 목록을 조회합니다.<br>" +
            "🔐 <strong>Jwt 필요</strong><br>"
    )
    @ApiResponses(
    ...
    @GetMapping("/terms")
    fun getTerms(): ResponseEntity<CourseTermsResponse>

    @Operation(
        summary = "연계전공 조회",
        description = "연계전공 목록을 조회합니다. 과목 적재 여부와 무관하게 전건이 내려갑니다.<br>" +
            "🔐 <strong>Jwt 필요</strong><br>"
    )
    @ApiResponses(
    ...
    fun getInterdisciplinaryMajors(): ResponseEntity<InterdisciplinaryMajorsResponse>

    @Operation(
        summary = "학과 조회",
        description = "과목을 개설하는 학과 목록을 조회합니다. 과목 적재 여부와 무관하게 전건이 내려갑니다.<br>" +
    ...
    fun getDepartments(): ResponseEntity<DepartmentsResponse>
}
