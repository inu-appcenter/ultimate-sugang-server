...
interface CartControllerDocs {
    @Operation(
        summary = "장바구니 조회",
        description = "사용자의 장바구니에 담긴 과목 목록을 조회합니다.<br>" +
    ...
    @Operation(
        summary = "장바구니 삭제",
        description = "특정 과목을 장바구니에서 삭제합니다.<br>" +
            "🔐 <strong>Jwt 필요</strong><br>"
    )
    @ApiResponses(
