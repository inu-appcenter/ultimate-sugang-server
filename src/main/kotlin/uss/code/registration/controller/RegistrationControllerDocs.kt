...
interface RegistrationControllerDocs {
    @Operation(
        summary = "수강신청 내역 조회",
        description = "사용자의 수강신청 내역을 조회합니다.<br>" +
    ...
    @GetMapping
    fun getRegistrationCourse(
        @Auth memberId: Long,
    ): ResponseEntity<RegistrationCoursesResponse>

    @Operation(
        summary = "수강신청 추가",
        description = "특정 과목을 수강신청합니다.<br>" +
    ...
    @Operation(
        summary = "수강신청 취소",
        description = "특정 과목의 수강신청을 취소합니다.<br>" +
            "🔐 <strong>Jwt 필요</strong><br>"
    )
    @ApiResponses(
